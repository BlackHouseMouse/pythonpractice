...
# This is me practicing the concept of numeric types in Python 3.x
...
exponent_float = 3e8 #e to indicate the power of 10
...
# Complex
# Numbers like 3+ 5j where j represents an imaginary part
